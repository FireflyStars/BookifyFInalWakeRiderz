@extends('layouts.admin', ['title' => __('backend.invoices')])

@section('content')

    <div class="page-title">
        <h3>{{ __('backend.all_booking_invoices') }}</h3>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">{{ __('backend.all_booking_invoices') }}</h4>
                    </div>
                            ...
                            <table id="xtreme-table" class="display table" style="width: 100%; cellspacing: 0;">
                                ...
                                @foreach($invoices as $invoice)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{ route('invoices.show', $invoice->id) }}" class="btn btn-primary btn-sm">{{ __('backend.view_invoice') }}</a>
                                            @if(!$invoice->is_paid && $invoice->booking->status != __('backend.cancelled'))
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ route('invoices.edit', $invoice->id) }}" class="btn btn-danger">{{ __('backend.paid') }}</a>
