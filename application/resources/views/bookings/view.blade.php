    ...
    <div id="main-wrapper">
        <div class="row">
            <div class="col-md-12">
                ...
                @if(Session::has('paypal_refund_failed'))
                    <div class="alert alert-danger">{{ session('paypal_refund_failed') }}</div>
                @endif
                @if(Session::has('stripe_refund_failed'))
                    <div class="alert alert-danger">{{ session('stripe_refund_failed') }}</div>
                @endif
            </div>
            <div class="col-md-6">
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                        <div id="account_details_view">
                            ...
                            <div class="row table-row">
                                <div class="col-md-6 bold-font"><strong>Group Size:</strong></div>
                                <div class="col-md-6">{{ $booking->group_size }}</div>
                            </div>
                            <div class="row table-row">
                                <div class="col-md-6 bold-font"><strong>Event Type:</strong></div>
                                <div class="col-md-6">{{ $booking->event_type }}</div>
                            </div>
                            <div class="row table-row">
                            ...
                            <div class="row table-row">
                                ...
                                <div class="col-md-6">{{ $booking->invoice->id }} -
                                    <a href="{{ route('invoices.show', $booking->invoice->id) }}">{{ __('backend.click_to_see') }}</a>
                                </div>
                            </div>
                            <div class="row table-row">
                            ...
                            @if($booking->promo_used)
                                <div class="row table-row">
                                    <div class="col-md-6 bold-font"><strong>{{ __('backend.coupon_code') }}</strong></div>
                                    <div class="col-md-6">{{ $booking->promo_used }}</div>
                                </div>
                                <div class="row table-row">
                                    <div class="col-md-6 bold-font"><strong>{{ __('backend.discount') }}</strong></div>
                                    <div class="col-md-6">{{ $booking->promo_discount }}%</div>
                                </div>
                            @endif
                        </div>
                        <h3>Notes:</h3>
            ...
            <div class="col-md-6">
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row table-row">
                            <div class="col-md-6 bold-font"><strong>City:</strong></div>
                            <div class="col-md-6">{{ $booking->city }}</div>
                        </div>
                        <div class="row table-row">
                            <div class="col-md-6 bold-font"><strong>State:</strong></div>
                            <div class="col-md-6">{{ $booking->state }}</div>
                        </div>
                        <div class="row table-row">
                            <div class="col-md-6 bold-font"><strong>Zip Code:</strong></div>
                            <div class="col-md-6">{{ $booking->zip }}</div>
                        </div>
                    </div>
                </div>
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">{{ __('backend.assigned') }}</h4>
                    </div>
                    <div class="panel-body">
                        <div class="row table-row">
                            <div class="col-md-6 bold-font"><strong>{{ __('backend.full_name') }}:</strong></div>
                            <div class="col-md-6">{{ $booking->staff->first_name }} {{ $booking->staff->last_name }}</div>
                        </div>
                        <div class="row table-row">
                            <div class="col-md-6 bold-font"><strong>{{ __('backend.phone_number') }}:</strong></div>
                            <div class="col-md-6"><a href="tel:{{ $booking->staff->phone_number }}">{{ $booking->staff->phone_number }}</a></div>
                        </div>
                        <div class="row table-row">
                            <div class="col-md-6 bold-font"><strong>{{ __('backend.email') }}:</strong></div>
                            <div class="col-md-6"><a href="mailto:{{ $booking->staff->email }}">{{ $booking->staff->email }}</a></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" required>
                                            <option {{ $booking->status == __('backend.processing') ? 'selected' : '' }}>{{ __('backend.processing') }}</option>
                                            <option {{ $booking->status == __('backend.in_progress') ? 'selected' : '' }}>{{ __('backend.in_progress') }}</option>
                                            <option {{ $booking->status == __('backend.completed') ? 'selected' : '' }}>{{ __('backend.completed') }}</option>
                                        </select>
                                    </div>
                                </div>
