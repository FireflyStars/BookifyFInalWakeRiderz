                    ...
                    @if(count($session_addons))
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <br><br>
                                <div class="owl-carousel owl-theme owl-loaded owl-drag owl-stage" id="addons_carousel">
                                    @foreach($addons as $addon)
                                        @if((new App\Http\Controllers\UserBookingController)->checkIfAdded($addon->id,Auth::user()->email))
                                            <div class="owl-item">
                                                <div class="card">
                                                    <img class="card-img-top img-fluid" alt="{{ $addon->title }}" src="{{ asset($addon->photo->file) }}">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="text-center package_description">{!! $addon->description !!}</div>
                                                    </div>
                                                    <div class="card-footer addon_buttons">
