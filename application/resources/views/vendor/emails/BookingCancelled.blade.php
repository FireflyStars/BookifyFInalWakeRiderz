                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <p style="text-align: left;"><strong><span style="font-size:24px">{{ __('emails.greeting') }} {{ $booking->user->first_name }} {{ $booking->user->last_name }}!</span></strong><br>
                                                                    ...
                                                                    @if($refund_status)
                                                                        ...
                                                                        Your payment of {!! config('settings.currency_symbol') !!}{{ $booking->invoice->amount }} is refunded via {{ $booking->invoice->payment_method }}. In case of any issue, please contact
                                                                        us.

                                                                    @else

                                                                        Your payment of {!! config('settings.currency_symbol') !!}{{ $booking->invoice->amount }} is not refundable. In case of any issue, please contact
                                                                        us.
