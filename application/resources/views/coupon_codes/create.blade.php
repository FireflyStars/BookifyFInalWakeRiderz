@extends('layouts.admin', ['title' => __('backend.add_new_coupon')])
...
@section('content')
    ...
    <div class="page-title">
        <h3>{{ __('backend.add_new_coupon') }}</h3>
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="{{ route('home') }}">{{ __('backend.home') }}</a></li>
                <li><a href="{{ route('coupon-codes.index') }}">{{ __('backend.coupons') }}</a></li>
                <li class="active">{{ __('backend.add_new_coupon') }}</li>
            </ol>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">{{ __('backend.provide_coupon_details') }}</h4>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="{{route('coupon-codes.store')}}">
                            {{csrf_field()}}
                            ...
                            <div class="col-md-6 form-group{{$errors->has('percentage') ? ' has-error' : ''}}">
                                ...
                                <input type="number" step="any" max="100" class="form-control" name="percentage" id="percentage" value="{{old('percentage')}}">
                            ...
                            <div class="col-md-6 form-group{{$errors->has('max_uses') ? ' has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="max_uses" id="max_uses" value="{{old('max_uses')}}">
                            ...
                            <div class="col-md-6 form-group{{$errors->has('valid_from') ? ' has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="valid_from" id="valid_from" value="{{old('valid_from')}}">
                            ...
                            <div class="col-md-6 form-group{{$errors->has('valid_to') ? ' has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="valid_to" id="valid_to" value="{{old('valid_to')}}">
                            ...
                            <div class="col-md-12 form-group text-right">
                                <button type="submit" class="btn btn-primary btn-lg">{{ __('backend.create_coupon') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
